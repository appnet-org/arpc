...
// 	protoc        v3.6.1
// source: symphony/benchmark.proto
...
func (x *RuntimeEnvUris) Reset() {
	*x = RuntimeEnvUris{}
	mi := &file_symphony_benchmark_proto_msgTypes[0]
...
func (*RuntimeEnvUris) Descriptor() ([]byte, []int) {
	return file_symphony_benchmark_proto_rawDescGZIP(), []int{0}
}
...
func (x *RuntimeEnvConfig) Reset() {
	*x = RuntimeEnvConfig{}
	mi := &file_symphony_benchmark_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RuntimeEnvConfig) Descriptor() ([]byte, []int) {
	return file_symphony_benchmark_proto_rawDescGZIP(), []int{1}
}
...
func (x *RuntimeEnvInfo) Reset() {
	*x = RuntimeEnvInfo{}
	mi := &file_symphony_benchmark_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RuntimeEnvInfo) Descriptor() ([]byte, []int) {
	return file_symphony_benchmark_proto_rawDescGZIP(), []int{2}
}
...
var File_symphony_benchmark_proto protoreflect.FileDescriptor

const file_symphony_benchmark_proto_rawDesc = "" +
	"\n" +
	"\x18symphony/benchmark.proto\x12\bsymphony\"`\n" +
...
var (
	file_symphony_benchmark_proto_rawDescOnce sync.Once
	file_symphony_benchmark_proto_rawDescData []byte
)

func file_symphony_benchmark_proto_rawDescGZIP() []byte {
	file_symphony_benchmark_proto_rawDescOnce.Do(func() {
		file_symphony_benchmark_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_symphony_benchmark_proto_rawDesc), len(file_symphony_benchmark_proto_rawDesc)))
	})
	return file_symphony_benchmark_proto_rawDescData
}

var file_symphony_benchmark_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_symphony_benchmark_proto_goTypes = []any{
...
var file_symphony_benchmark_proto_depIdxs = []int32{
...
func init() { file_symphony_benchmark_proto_init() }
func file_symphony_benchmark_proto_init() {
	if File_symphony_benchmark_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_symphony_benchmark_proto_rawDesc), len(file_symphony_benchmark_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_symphony_benchmark_proto_goTypes,
		DependencyIndexes: file_symphony_benchmark_proto_depIdxs,
		MessageInfos:      file_symphony_benchmark_proto_msgTypes,
	}.Build()
	File_symphony_benchmark_proto = out.File
	file_symphony_benchmark_proto_goTypes = nil
	file_symphony_benchmark_proto_depIdxs = nil
}
