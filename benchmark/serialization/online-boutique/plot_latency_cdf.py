#!/usr/bin/env python3
"""
Online Boutique Serialization Latency CDF Plotter
...
Online Boutique benchmark payloads.
...
Output:
    - online_boutique_serialization_latency_cdf.pdf: A PDF file containing side-by-side CDF plots
      for write and read latencies with a shared legend at the bottom (base formats only).
    - online_boutique_serialization_latency_cdf_hybrid.pdf: A PDF file when --include-hybrid is used,
...
OUTPUT_FILE_BASE = "online_boutique_serialization_latency_cdf.pdf"
OUTPUT_FILE_HYBRID = "online_boutique_serialization_latency_cdf_hybrid.pdf"
...
def main():
    parser = argparse.ArgumentParser(description='Plot CDF of serialization latency for Online Boutique benchmark')
