...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  GetResponse get(GetRequest req)")
	fmt.Fprintln(os.Stderr, "  SetResponse setValue(SetRequest req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := kv.NewKVServiceClient(thrift.NewTStandardClient(iprot, oprot))
	...
	case "get":
		...
		argvalue0 := kv.NewGetRequest()
		err17 := argvalue0.Read(context.Background(), jsProt16)
		if err17 != nil {
			Usage()
			return
		}
		fmt.Print(client.Get(context.Background(), argvalue0))
		fmt.Print("\n")
		break
	case "setValue":
		if flag.NArg()-1 != 1 {
		...
		argvalue0 := kv.NewSetRequest()
		err23 := argvalue0.Read(context.Background(), jsProt22)
		if err23 != nil {
			Usage()
			return
		}
		fmt.Print(client.SetValue(context.Background(), argvalue0))
		fmt.Print("\n")
		break
	case "":
		Usage()
