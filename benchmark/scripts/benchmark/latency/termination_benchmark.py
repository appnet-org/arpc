...
manifest_dict = {
    ...
    "kv-store-grpc-envoy-tcp": os.path.join(ARPC_DIR, "benchmark/scripts/benchmark/latency/termination-manifest/kvstore-envoy-tcp.yaml"),
    "kv-store-grpc-envoy-h2": os.path.join(ARPC_DIR, "benchmark/scripts/benchmark/latency/termination-manifest/kvstore-envoy-h2.yaml"),
}
