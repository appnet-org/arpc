#!/usr/bin/env python3
"""
Triple Encryption Benchmark Latency CDF Plotter
...
Triple Benchmark Pattern:
    - Whole: 3x encrypt/decrypt operations per iteration
    - Split: 1x both splits + 2x first split only per iteration

Supported Strategies:
    - Whole: Encrypt/decrypt entire message at once (3 times)
    - Random Split: Split message at random boundaries (1x both + 2x first)
    - Key-Value Split: Split message at key/value boundary (1x both + 2x first)

Usage:
    python plot_triple_encryption_cdf.py
...
Input Files:
    The script expects CSV timing data files in the 'profile_data/' directory:
        - triple_encryption_whole_encrypt_times.csv
        - triple_encryption_whole_decrypt_times.csv
        - triple_encryption_random_split_encrypt_times.csv
        - triple_encryption_random_split_decrypt_times.csv
        - triple_encryption_key_value_split_encrypt_times.csv
        - triple_encryption_key_value_split_decrypt_times.csv
...
Output:
    - triple_encryption_latency_cdf.pdf: A PDF file containing side-by-side CDF plots
