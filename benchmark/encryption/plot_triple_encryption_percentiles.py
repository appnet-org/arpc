#!/usr/bin/env python3
"""
Triple Encryption Benchmark Percentile Bar Chart
...
Usage:
    python plot_triple_encryption_percentiles.py
...
Output:
    - triple_encryption_latency_percentiles.pdf: Bar chart comparing percentiles
"""
...
def plot_percentile_table(encrypt_data, decrypt_data, output_filename=OUTPUT_FILE):
    ...
    # Add title
    ax.set_title('Triple Encryption Latency Percentiles', fontsize=14, fontweight='bold', pad=20)
...
def print_percentile_table(encrypt_data, decrypt_data):
    ...
    print("\n" + "="*80)
    print("TRIPLE ENCRYPTION LATENCY PERCENTILES (nanoseconds)")
    print("="*80)
