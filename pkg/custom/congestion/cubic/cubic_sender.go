...
import (
	...
	"github.com/appnet-org/arpc/pkg/custom/congestion/cubic/qlog"
...
func newCubicSender(
	...
	logging.Debug("Cubic sender initialized", zap.String("state", c.lastState.String()))
	return c
}
...
func (c *cubicSender) maybeQlogStateChange(new qlog.CongestionState) {
	...
	logging.Debug("Cubic sender state changed", zap.String("new", new.String()))
	c.lastState = new
}
