...
var math = protogen.GoImportPath("math")
...
func generateDirectFieldRead(g *protogen.GeneratedFile, fieldExpr string, field *protogen.Field, dataVar string, offsetVar string) {
	...
	case 4:
		...
		case protoreflect.FloatKind:
			g.P("                    ", fieldExpr, " = ", math.Ident("Float32frombits"), "(binary.LittleEndian.Uint32(", dataVar, "[", offsetVar, ":", offsetVar, "+4]))")
	...
	case 8:
		...
		case protoreflect.DoubleKind:
			g.P("                    ", fieldExpr, " = ", math.Ident("Float64frombits"), "(binary.LittleEndian.Uint64(", dataVar, "[", offsetVar, ":", offsetVar, "+8]))")
		default:
...
func generateFixedFieldWrite(g *protogen.GeneratedFile, fieldExpr string, field *protogen.Field) {
	...
	case 4:
		...
		case protoreflect.FloatKind:
			g.P("        binary.LittleEndian.PutUint32(temp[:4], ", math.Ident("Float32bits"), "(", fieldExpr, "))")
		case protoreflect.EnumKind:
			g.P(fmt.Sprintf("        binary.LittleEndian.PutUint32(temp[:4], uint32(%s))", fieldExpr))
		default:
			panic(fmt.Sprintf("Unhandled 4-byte field type: %v", kind))
	...
	case 8:
		...
		case protoreflect.DoubleKind:
			g.P("        binary.LittleEndian.PutUint64(temp[:8], ", math.Ident("Float64bits"), "(", fieldExpr, "))")
		default:
			panic(fmt.Sprintf("Unhandled 8-byte field type: %v", kind))
		}
