...
-A OUTPUT -p udp -m udp --dport 10000:65535 -m owner ! --uid-owner 1337 -j REDIRECT --to-ports 15002
-A OUTPUT -p udp -m connmark --mark 0x2 -m owner ! --uid-owner 1337 -j REDIRECT --to-ports 15006
COMMIT
EOF
